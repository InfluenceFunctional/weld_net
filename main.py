...
parser.add_argument('--fc_depth', type = int, default = 32)
...
parser.add_argument('--max_dataset_size', type = int, default = 1000) # maximum dataset size (limited by size of actual dataset) - not sure the dataset is properly shuffled prior to this being applied
